 ...
 *
 * The class derives from autogenerated BaseSimulationInterfaceSource class. The
 ...
 * autogenerated by a Qt Remote Object Compiler from basesimulationinterface.rep file.
 * \sa https://doc.qt.io/qt-5/qtremoteobjects-gettingstarted.html
 *
 * The SimulationInterface is responsible for connecting its appropriate signals/slots
 ...
 * simply act as signals reemiters. A custom simulation program may connect the desired
 * signals and slots of the QtRO replica and thus interact with the GUI.
 */
...
public slots:
     ...
     */
    virtual void situationRectDimensionsInfoReemit(const RectDimensionsType rect);
